...
import { MarkerType, VideoData, Marker } from './types';
...
export const Icons = {
  ...
  Sort: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 5h10"/><path d="M11 9h7"/><path d="M11 13h4"/><path d="M3 17l3 3 3-3"/><path d="M6 18V4"/></svg>
  ),
...
// --- Initial Data ---
export const INITIAL_MARKER_TYPES: MarkerType[] = [
